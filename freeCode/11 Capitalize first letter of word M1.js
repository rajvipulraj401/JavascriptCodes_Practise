...
function titleCase(str) {
  ...
  for (let i = 0; i < newTitle.length; i++) {
    ...
    updatedTitle[i] =
      newTitle[i][0].toUpperCase() + newTitle[i].slice(1).toLowerCase();
  }
...
split("") use another empty array and then capitalize first letter using toUpperCase()+ splitted array [i].slice.toLowerCase() and then joining that 
updated title using join("")
